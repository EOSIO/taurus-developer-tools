...
namespace eosio {
inline constexpr bool is_basic_abi_type(const input_stream*){ return true; }
inline constexpr bool is_basic_abi_type(const test_protocol::transaction_status*){ return true; }

...
struct abieos_sql_converter {
    ...
    // for debug mode
    abieos_contracts_manager *contracts_manager = nullptr;
    bool debug_mode = false;

    void set_abieos_contracts_manager(abieos_contracts_manager *ptr);

    std::string contract_name_debug;
    std::string action_name_debug;
};